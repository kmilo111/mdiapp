...
class FormEvent extends Component {
  ...
  handleTipoEvento(event){
    ...
    //obtener el texto del option para hacer la consulta de las dimensiones
  ...
  handleBlur(event){
   ...
   render() {
    ...
    const { dataEvents, 
            ...
            dataPeriodEvent, 
            dataCityEvent,
            dataDimensionTypeEvent} = this.state;
             ...
             <div className="modal-content">
               <div className="modal-header">
                 ...
                 <div className="modal-body" style={renderFormChannel ? divStyle : divStyle2 }>
                  {renderForm  ? (<PrecioForm onSubmit={PrecioForma} />):(<InscripcionesForm />)}
                </div>
